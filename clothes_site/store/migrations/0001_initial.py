# Generated by Django 5.1.3 on 2025-02-03 04:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number', phonenumber_field.modelfields.PhoneNumberField(max_length=128, region='KG')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clothes_description', models.TextField(blank=True, null=True)),
                ('clothes_discount', models.PositiveSmallIntegerField(blank=True, help_text='процент скидки', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('favorite_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='favorite', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='About_me',
            fields=[
                ...
                ('connect', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='about_me', to='store.mainabout_me')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('order_status', models.CharField(choices=[('обработка', 'Oбработка'), ('заказ собирается', 'заказ собирается'), ('в процессе доставки', 'в процессе доставки'), ('доставлен', 'Доставлен'), ('отменен', 'Отменен')], default='Oбработка', max_length=32)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('connect', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pay_title', to='store.pay')),
            ],
        ),
        migrations.CreateModel(
            name='Photo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='store.photo')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clothes1', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='first', to='store.clothes')),
                ('clothes2', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='second', to='store.clothes')),
                ('clothes3', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='three', to='store.clothes')),
            ],
        ),
    ]
